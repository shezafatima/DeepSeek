...
<p className='group-hover:max-w-5/6 truncate'>Chat Name Here</p>
    <div className='group relative flex items-center justify-center h-6 w-6 aspect-square hover:bg-black/80 rounded-lg'>
        ...
        <HiOutlineDotsHorizontal className={`w-4 ${openMenu.open ? '': 'hidden'} group-hover:block`}
         />
...
<PiPencilSimpleLineLight size={24} className='w-4'/>
              ...
              <div className='flex items-center gap-3 hover:bg-white/10 px-3 py-2 rounded-lg text-red-500'>
